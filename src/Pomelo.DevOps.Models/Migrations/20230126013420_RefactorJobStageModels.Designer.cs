...
namespace Pomelo.DevOps.Models.Migrations
{
    ...
    [Migration("20230126013420_RefactorJobStageModels")]
    partial class RefactorJobStageModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pomelo.DevOps.Models.Job", b =>
                {
                    ...
                    b.Property<Guid?>("DiagramWorkflowInstanceId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("DiagramWorkflowInstanceId");
            ...
            modelBuilder.Entity("Pomelo.DevOps.Models.JobStageWorkflow", b =>
                {
                    ...
                    b.HasKey("JobStageId", "WorkflowInstanceId");
            ...
            modelBuilder.Entity("Pomelo.DevOps.Models.PipelineDiagramStage", b =>
                {
                    ...
                    b.ToTable("PipelineDiagramStages");
                });
            ...
            modelBuilder.Entity("Pomelo.Workflow.Models.EntityFramework.DbStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("WorkflowInstanceId", "ShapeId");

                    b.ToTable("WorkflowInstanceSteps");
                });

            modelBuilder.Entity("Pomelo.Workflow.Models.EntityFramework.DbWorkflow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pomelo.Workflow.Models.EntityFramework.DbWorkflowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pomelo.Workflow.Models.EntityFramework.DbWorkflowInstanceConnection", b =>
                {
                    b.Property<Guid>("InstanceId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("ConnectPolylineId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("WorkflowInstanceId")
                        .HasColumnType("char(36)");

                    b.HasKey("InstanceId", "ConnectPolylineId");

                    b.HasIndex("WorkflowInstanceId");

                    b.ToTable("WorkflowInstanceConnections");
                });

            modelBuilder.Entity("Pomelo.Workflow.Models.EntityFramework.DbWorkflowVersion", b =>
                {
                    b.Property<Guid>("WorkflowId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pomelo.DevOps.Models.Job", b =>
                {
                    b.HasOne("Pomelo.Workflow.Models.EntityFramework.DbWorkflowInstance", "DiagramWorkflowInstance")
                        .WithMany()
                        .HasForeignKey("DiagramWorkflowInstanceId");
                    ...
                    b.Navigation("DiagramWorkflowInstance");
            ...
            modelBuilder.Entity("Pomelo.DevOps.Models.JobStageWorkflow", b =>
                {
                    b.HasOne("Pomelo.DevOps.Models.Job", null)
                        .WithMany("WorkflowStages")
                        .HasForeignKey("JobId");

                    b.HasOne("Pomelo.DevOps.Models.JobStage", "JobStage")
                        .WithOne("JobStageWorkflow")
                        .HasForeignKey("Pomelo.DevOps.Models.JobStageWorkflow", "JobStageId");
